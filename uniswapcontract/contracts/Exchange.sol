...
contract Exchange is ERC20 {
    ...
    function addLiquidity(
        ...
        uint256 ethReserveBalance = address(this).balance;  // returns the balance of ETH in the contract
        uint256 tokenReserveBalance = getReserve();         // returns the balance of token in the contract 
